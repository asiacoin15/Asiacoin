...
!define URL http://www.asiacoin.org/
...
OutFile asiacoin-${VERSION}-win32-setup.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Asiacoin.lnk" $INSTDIR\asiacoin-qt.exe
    ...
    WriteRegStr HKCR "asiacoin" "URL Protocol" ""
    WriteRegStr HKCR "asiacoin" "" "URL:Asiacoin"
    WriteRegStr HKCR "asiacoin\DefaultIcon" "" $INSTDIR\asiacoin-qt.exe
    WriteRegStr HKCR "asiacoin\shell\open\command" "" '"$INSTDIR\asiacoin-qt.exe" "%1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Asiacoin.lnk"
    Delete /REBOOTOK "$SMSTARTUP\Asiacoin.lnk"
